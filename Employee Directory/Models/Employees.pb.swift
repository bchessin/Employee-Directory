...
extension Employees: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "Employees"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "employees"),
  ]
